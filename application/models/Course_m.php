...
class Course_m extends CI_Model
{
    ...
    function get_course_detail($id)
    {
        ...
        c_detail.course_detail_title,c_detail.course_detail_duration,c_detail.course_detail_video_code');
    ...
    function get_course_detail_id($id, $detail_id_lesson)
    {
        ...
        $query = "SELECT c.id, c.course_title, 
        c_detail.id, c_detail.course_detail_title,c_detail.course_detail_duration, c_detail.course_detail_video_code 
        FROM tm_course_detail as c_detail 
    ...
    function total_video_course_by_id($id)
    {
        return $this->db->where('course_id', $id)->get('tm_course_detail')->num_rows();
    }
}
