<div class="row">
    ...
    <div class="col-12">
        <form action="<?php echo base_url('course/content/update/submit') ?>" method="post">
            <input type="hidden" name="detail_id" value="<?php echo $detail_id; ?>">
            <!-- Input -->
            <div class="mb-3">
                <label class="form-label" for="textInput">Judul Kursus</label>
                <input type="text" class="form-control" name="course_detail_title" placeholder="Judul Kursus"
                    value="<?php echo $youtube_title; ?>">
            </div>
            <!-- Input -->
            <div class="mb-3">
                <label class="form-label" for="textInput">Durasi Kursus</label>
                <input type="text" class="form-control" name="course_detail_duration" placeholder="Durasi Kursus"
