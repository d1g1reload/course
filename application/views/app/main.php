<style>
/* Memastikan tab yang aktif selalu berada di atas layer tab yang sembunyi */
.tab-content .tab-pane.active {
    position: relative;
    z-index: 999;
    display: block !important;
    /* Memastikan display block aktif */
}

/* Memastikan tab yang tidak aktif benar-benar hilang */
            ...
            <div class="col-md-12">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <?php foreach ($categories as $index => $cat) :
                        ...
                        ?>
                    <div class="tab-pane <?php echo $show_active; ?>" id="pills-cat-<?php echo $cat->id; ?>"
