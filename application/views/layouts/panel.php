...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/backend/vendor/datatables/dataTables.bootstrap4.min.css"
        rel="stylesheet">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="rounded-top"
                            style="background: url(<?php echo base_url() ?>assets/images/background/profile-bg.jpg) no-repeat; background-size: cover; height: 100px">
                        </div>
                            ...
                            <div class="d-flex align-items-end justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div
                                        ...
                                        <img src="https://ui-avatars.com/api/?rounded=true&name=<?php echo $this->session->userdata('fullname') ?>"
                                        ...
                                        <a href="#" class="position-absolute top-0 end-0" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?php echo base_url() ?>assets/images/svg/checked-mark.svg"
                                                alt="checked" height="30" width="30" />
                                        </a>
                                    </div>
                                    <div class="lh-1">
                                ...
                                <div>
                                    <a href="<?php echo base_url('page/course/create') ?>"
                                        class="btn btn-primary d-none d-md-block">Buat Kursus</a>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="collapse navbar-collapse" id="sidenav">
                                <div class="navbar-nav flex-column">
                                    ...
                                    <ul class="list-unstyled ms-n2">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link"
                                                href="<?php echo base_url('page/student/lecture/list') ?>">
